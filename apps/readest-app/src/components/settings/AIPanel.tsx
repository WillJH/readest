    ...
    <div className='my-4 w-full space-y-6'>
      ...
      <BoxedList title={_('Prompts')} className={disabledSection}>
        <div className='flex flex-col gap-2 px-4 py-3'>
          ...
          <span className='text-base-content/60 text-xs'>
            {_(
              'Appended to every message you send. Never shown in the thread. Who the AI is comes from the character persona or the connection\u2019s system prompt; these instructions are user-level.',
            )}
          </span>
        </div>
      </BoxedList>
